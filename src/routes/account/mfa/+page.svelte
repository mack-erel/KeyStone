    ...
    <div class="mx-auto max-w-lg">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            {#if backupCodes}
                <div class="mb-6 rounded-xl border border-green-200 bg-green-50 p-5">
                    ...
                    <p class="mb-4 text-sm text-green-700">
                        이 코드는 지금만 표시됩니다. 안전한 곳에 저장해 두세요. 코드 하나당 1회만
                        사용 가능합니다.
                    </p>
            ...
            {#if isSetupMode}
                <div class="space-y-5">
                    ...
                    <div class="flex flex-col items-center gap-3">
                        ...
                        {:else}
                            <div
                                class="flex h-50 w-50 items-center justify-center rounded-lg border border-gray-200 bg-gray-50">
            ...
            {:else if data.enrolled}
                <div class="space-y-5">
                    <div
                        class="flex items-center gap-3 rounded-xl border border-green-200 bg-green-50 p-4">
                        <svg
                            ...
                            <form
                                ...
                                <button
                                    ...
                                    onclick={(e) => {
                                        if (
                                            !confirm(
                                                "기존 백업 코드가 모두 삭제되고 새로 발급됩니다. 계속하시겠습니까?",
                                            )
                                        ) {
                                            e.preventDefault();
                                        }
                    ...
                    <form method="POST" action="?/delete" use:enhance class="space-y-2">
                        ...
                        <button
                            ...
                            onclick={(e) => {
                                if (
                                    !confirm(
                                        "TOTP 인증기와 모든 백업 코드가 삭제됩니다. 계속하시겠습니까?",
                                    )
                                ) {
                                    e.preventDefault();
                                }
                ...
                <div class="space-y-5">
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4">
                        <p class="text-sm text-gray-600">
                            2단계 인증을 활성화하면 계정 보안이 강화됩니다. Google Authenticator,
                            Authy 등의 인증 앱이 필요합니다.
                        </p>
                    </div>
