        ...
        <div class="rounded-xl border border-blue-100 bg-blue-50 p-5">
            ...
            <form
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="c-tlsMode" class="block text-xs font-medium text-gray-700"
                            >TLS 모드</label>
                        <select
                            id="c-tlsMode"
                            name="tlsMode"
                    ...
                    <div>
                        <label for="c-host" class="block text-xs font-medium text-gray-700"
                            >호스트 *</label>
                        <input
                            id="c-host"
                            type="text"
                    ...
                    <div>
                        <label for="c-port" class="block text-xs font-medium text-gray-700"
                            >포트</label>
                        <input
                            id="c-port"
                            type="number"
                    ...
                    <div>
                        <label for="c-baseDN" class="block text-xs font-medium text-gray-700"
                            >Base DN</label>
                        <input
                            id="c-baseDN"
                            type="text"
                ...
                <details class="rounded-lg border border-gray-200 bg-white" open>
                    ...
                    <div class="space-y-3 p-4">
                        <p class="text-xs text-gray-500">
                            Admin Bind DN을 입력하면 Search 방식을 사용합니다. 비워두면 유저 DN
                            패턴을 사용합니다.
                        </p>
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                            ...
                            <div>
                                <label
                                    for="c-pattern2"
                                    class="block text-xs font-medium text-gray-700">
                                    유저 DN 패턴 <span class="text-gray-400"
                                        >(Admin Bind 미사용 시)</span>
                                </label>
                                <input
                                    id="c-pattern2"
                                    type="text"
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <button
                                        ...
                                        onclick={() =>
                                            (editingId =
                                                editingId === provider.id ? null : provider.id)}
                                    ...
                                    <form method="POST" action="?/delete" use:enhance>
                                        ...
                                        <button
                                            ...
                                            onclick={(e) => {
                                                if (!confirm("LDAP 프로바이더를 삭제하시겠습니까?"))
                                                    e.preventDefault();
                                            }}>
                                            삭제
                                        </button>
                                    ...
                                    <form
                                        ...
                                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    <option
                                                        value="none"
                                                        selected={c.tlsMode === "none"}
                                                        >없음 (ldap://)</option>
                                                    <option
                                                        value="tls"
                                                        selected={c.tlsMode === "tls"}
                                                        >TLS (ldaps://)</option>
                                                    <option
                                                        value="starttls"
                                                        selected={c.tlsMode === "starttls"}
                                                        >STARTTLS</option>
                                                </select>
                                            </div>
                                            <div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <label
                                                    for="e-enabled-{provider.id}"
                                                    class="text-xs text-gray-700">활성화</label>
                                            </div>
