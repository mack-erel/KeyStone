			...
			<form
				...
				<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
					...
					<div>
						...
						<input id="c-port" type="number" name="port" value="389" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none" />
					</div>
					<div>
					...
					<div class="space-y-3 p-4">
						...
						<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
							...
							<div>
								...
								<input id="c-bindPw" type="password" name="bindPassword" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none" />
							</div>
							<div>
									...
									<form
										...
										<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
											...
											<div>
												...
												<select id="e-tls-{provider.id}" name="tlsMode" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none">
										...
										<div class="flex items-center justify-between">
											<div class="flex items-center gap-2">
												<input id="e-enabled-{provider.id}" type="checkbox" name="enabled" value="true" checked={provider.enabled} class="h-4 w-4 rounded border-gray-300 text-blue-600" />
