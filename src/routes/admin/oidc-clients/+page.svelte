		...
		<div class="rounded-xl border border-blue-100 bg-blue-50 p-5">
			...
			<form
				...
				<div class="sm:col-span-2">
					...
					<textarea id="c-redirectUris" name="redirectUris" required rows="3" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none"
					></textarea>
				</div>
				<div class="sm:col-span-2">
					<label for="c-postLogout" class="block text-xs font-medium text-gray-700">Post-Logout Redirect URIs (줄바꿈 구분)</label>
					<textarea id="c-postLogout" name="postLogoutRedirectUris" rows="2" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none"
					></textarea>
				</div>
				<div>
									...
									<form
										...
										<div class="sm:col-span-2">
											...
											<textarea
												...
												required
												rows="3"
												class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none">{urisToText(client.redirectUris)}</textarea>
										</div>
										<div class="sm:col-span-2">
											...
											<textarea
												...
												rows="2"
												class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none">{urisToText(client.postLogoutRedirectUris)}</textarea>
										</div>
