						...
						<tr class="hover:bg-gray-50">
							...
							<td class="px-4 py-3">
								<div class="flex items-center gap-2">
									<button
										type="button"
										onclick={() => (editingId = editingId === client.id ? null : client.id)}
									...
									<form method="POST" action="?/regenerateSecret" use:enhance>
										...
										<button
											...
											onclick={(e) => {
												if (
													!confirm('시크릿을 재생성하시겠습니까? 기존 시크릿은 즉시 무효화됩니다.')
												)
													e.preventDefault();
											}}
										>
									...
									>
										...
										<div>
											<label
												...
												class="block text-xs font-medium text-gray-700">Scopes</label
											>
											<input
										...
										<div class="flex items-center gap-4">
											<div class="flex items-center gap-2">
												...
												/>
												<label for="e-pkce-{client.id}" class="text-xs text-gray-700"
													>PKCE 필수</label
												>
											</div>
											<div class="flex items-center gap-2">
