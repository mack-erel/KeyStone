                ...
                {:else}
                    {#each data.keys as key (key.id)}
                        <tr class="hover:bg-gray-50 {key.active ? '' : 'opacity-60'}">
                            <td
                                class="max-w-40 truncate px-4 py-3 font-mono text-xs text-gray-700"
                                title={key.kid}>{key.kid}</td>
                            ...
                            <td class="px-4 py-3">
                                <span
                                    class="rounded-full px-2 py-0.5 text-xs font-medium {key.active
                            ...
                            <td class="px-4 py-3 text-xs text-gray-400"
                                >{dateFormatter.format(key.createdAt)}</td>
                            <td class="px-4 py-3 text-xs text-gray-400">
