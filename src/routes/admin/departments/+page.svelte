	...
	<div class="overflow-x-auto rounded-xl border border-gray-200 bg-white shadow-sm">
		<table class="min-w-full divide-y divide-gray-200">
			<thead class="bg-gray-50">
				<tr>
					<th class="px-4 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">부서명</th>
					<th class="px-4 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">코드</th>
					<th class="px-4 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">상위 부서</th>
								...
								<div class="flex gap-2">
									...
									<form method="POST" action="?/delete" use:enhance>
										...
										<button
											...
											onclick={(e) => {
												if (!confirm('삭제하시겠습니까? 하위 부서의 상위 부서 연결이 해제됩니다.')) e.preventDefault();
											}}>삭제</button>
									</form>
								</div>
							</td>
