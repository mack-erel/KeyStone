    ...
    {#if showCreate}
        <div class="rounded-xl border border-blue-100 bg-blue-50 p-5">
            ...
            <form
                ...
                <div>
                    <label for="dept-name" class="block text-xs font-medium text-gray-700"
                        >부서명 *</label>
                    <input
                        id="dept-name"
                        type="text"
                ...
                <div>
                    <label for="dept-code" class="block text-xs font-medium text-gray-700"
                        >코드</label>
                    <input
                        id="dept-code"
                        type="text"
                ...
                <div>
                    <label for="dept-parentId" class="block text-xs font-medium text-gray-700"
                        >상위 부서</label>
                    <select
                        id="dept-parentId"
                        name="parentId"
                ...
                <div>
                    <label for="dept-displayOrder" class="block text-xs font-medium text-gray-700"
                        >표시 순서</label>
                    <input
                ...
                <div class="sm:col-span-2">
                    <label for="dept-description" class="block text-xs font-medium text-gray-700"
                        >설명</label>
                    <input
                        id="dept-description"
                        type="text"
                    ...
                    {#each data.departments as dept (dept.id)}
                        <tr class="hover:bg-gray-50">
                                ...
                                <td colspan="4" class="px-4 py-3">
                                    <form
                                        ...
                                        <select
                                            ...
                                            <option
                                                value="active"
                                                selected={dept.status === "active"}>활성</option>
                                            <option
                                                value="inactive"
                                                selected={dept.status === "inactive"}
                                                >비활성</option>
                                        </select>
                            ...
                            {:else}
                                ...
                                <td class="px-4 py-3">
                                    <span
                                        class="rounded-full px-2 py-0.5 text-xs font-medium {STATUS_COLOR[
                                            dept.status
                                        ]}">{STATUS_LABEL[dept.status]}</span>
                                </td>
                            {/if}
                            <td class="px-4 py-3">
                                <div class="flex gap-2">
                                    <button
                                        type="button"
                                        onclick={() =>
                                            (editId = editId === dept.id ? null : dept.id)}
                                    ...
                                    <form method="POST" action="?/delete" use:enhance>
                                        ...
                                        <button
                                            ...
                                            onclick={(e) => {
                                                if (
                                                    !confirm(
                                                        "삭제하시겠습니까? 하위 부서의 상위 부서 연결이 해제됩니다.",
                                                    )
                                                )
                                                    e.preventDefault();
                                            }}>삭제</button>
